...
<template>
  ...
  <Features />
  <Pricing />
  <section id="support" class="mx-auto max-w-7xl sm:px-6 lg:px-8">
    <Support />
  </section>
  <Blog />
  <Team />
  <section id="about" class="mx-auto max-w-7xl sm:px-6 lg:px-8">
    <Status />
  </section>
  <Testimonials />
  <NewsLatter />
    ...
    <div class="px-6 pt-16 pb-8 mx-auto max-w-7xl sm:pt-24 lg:px-8 lg:pt-32">
      ...
      <div class="pt-8 mt-8 border-t border-white/10 md:flex md:items-center md:justify-between">
        ...
        <p class="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
          &copy; 2023 Ostheir Weather Info, Inc. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
