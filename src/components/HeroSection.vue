...
<template>
  ...
  <div class="bg-white">
    <header class="absolute inset-x-0 top-0 z-50">
      ...
      <div :class="isMenuOpen ? 'block' : 'hidden'" role="dialog" aria-modal="true">
    ...
    <section class="relative isolate pt-14">
      <!-- Background grid -->
      <svg
        class="absolute inset-0 -z-10 h-full w-full stroke-yellow-200 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]"
        aria-hidden="true">
        <defs>
        ...
        <svg x="50%" y="-1" class="overflow-visible fill-yellow-100">
        ...
        <div class="max-w-2xl mx-auto lg:mx-0 lg:flex-auto">
          <div class="flex">
            <div
              ...
              <span class="font-semibold text-yellow-600">We’re hiring</span>
          ...
          <div class="flex items-center mt-10 gap-x-6">
            <a href="#"
              class="rounded-md bg-yellow-400 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-yellow-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
              Get started
            </a>
            <a href="#" class="text-sm font-semibold leading-6 text-gray-900">
        ...
        <div class="mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow">
          <svg viewBox="0 0 366 729" role="img" class="mx-auto w-[22.875rem] max-w-full drop-shadow-xl">
            ...
            <foreignObject width="316" height="684" transform="translate(24 24)"
              ...
              <img :src="data.heroData.image" alt="" />
            </foreignObject>
          </svg>
        </div>
      </div>
